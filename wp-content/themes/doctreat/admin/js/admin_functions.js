...
jQuery(document).ready(function(e) {
	...
	jQuery(document).on('click', '.add_more_testimonial', function (event) {
		...
		$html	= '<div class="data-services"><p><label for="">Client Name</label><input type="text" id="heading" name="widget-doctreat_testimonial['+widget+'][client][]" value="" class="widefat" /></p> <p><label for="description">Description</label><textarea id="description"  rows="8" cols="10" name="widget-doctreat_testimonial['+widget+'][description][]" class="widefat"></textarea></p><p class="data-del"><a href="javascript:;" class="delete-me"><i class="fa fa-times"></i></a></p></div>';
