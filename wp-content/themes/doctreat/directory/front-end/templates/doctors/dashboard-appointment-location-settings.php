...
<div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-6">
	<div class="dc-dashboardbox">
		<div class="dc-dashboardboxtitle dc-titlewithbtn dc-addnew">
			<h2><?php esc_html_e('Appointment Settings','doctreat');?></h2>
			<a href="<?php Doctreat_Profile_Menu::doctreat_profile_menu_link('profile', $user_identity, '','location'); ?>" target="_blank" class="dc-add_education"><?php esc_html_e('Add/Update location','doctreat');?></a>
		</div>
