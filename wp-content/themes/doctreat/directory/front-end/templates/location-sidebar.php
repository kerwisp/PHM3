...
<div class="dc-contactinfobox dc-locationbox">
    ...
    <?php if (!empty($address)) { ?>
        <a class="dc-btn dc-btn-lg" href="https://www.google.com/maps/place/<?php echo esc_js($latitude);?>,<?php echo esc_js($longitude);?>/@<?php echo esc_js($latitude);?>,<?php echo esc_js($longitude);?>,17z" target="_blank"><?php esc_html_e('Get Directions', 'doctreat'); ?></a>
    <?php } ?>
</div>
<?php
    $script = "
