						...
						<div class="dc-recentapoint">
							...
							<div class="dc-recentapoint-content dc-apoint-noti dc-noti-colorone">
								...
								<div class="dc-recent-content">
									...
									<a href="javascript:;" class="dc-btn dc-btn-sm" id="dc-booking-service" data-type="patient" data-id="<?php echo intval($post->ID); ?>"><?php esc_html_e('View Details','doctreat');?></a>
								</div>
							</div>
						</div>
					<?php
