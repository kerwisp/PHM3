	...
	function doctreat_get_booking_byID() {
		...
		if(!empty($booking_id)) {
			...
			if( empty($booking_user_type) || $booking_user_type ==='regular_users' ){
				$link_id		= doctreat_get_linked_profile_id( $post_author );
				$thumbnail      = doctreat_prepare_thumbnail($link_id, $width, $height);
				$user_type		= apply_filters('doctreat_get_user_type', $post_author );
			...
			<div class="dc-user-header">
				...
				<div class="dc-title">
					...
					<?php if( !empty( $name ) ){?>
						<h3>
							<?php 
								...
								if(!empty($post_author) && $post_author !=1 ){
									doctreat_get_verification_check($post_author);
								}
							?>
						</h3>
						<?php if( !empty($email) ){?>
						...
						<?php } ?>
					<?php } ?>
					<?php if(!empty($post_author) && $post_author !=1 ){ ?>
