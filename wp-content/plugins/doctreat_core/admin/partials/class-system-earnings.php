...
class Doctreat_earnings {
	...
	public function earnings_menu() {
		$hook = add_submenu_page('edit.php?post_type=doctors', 
							 esc_html__('Earnings','doctreat_core'), 
							 esc_html__('Earnings','doctreat_core'), 
							 'manage_options', 
							 'earnings',
	...
	?>
		<div class="wrap">
			<h2><?php esc_html_e('Earnings','doctreat_core');?></h2>
			<div id="poststuff">
	...
	public function screen_option() {
		...
		$args   = array(
			'label'   => esc_html__('Earnings','doctreat_core'),
			'default' => 20,
			'option'  => 'earnings_per_page'
		);
...
$earnings	= new Doctreat_earnings();
