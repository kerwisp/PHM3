...
if (!class_exists('AM_Metaboxes')) {
    ...
    class AM_Metaboxes {
        ...
        public function am_meta_boxes() {
            $this->add_meta_box('page_options', esc_html__('Page Options','doctreat_core'), 'page');
            $this->add_meta_box('post_options', esc_html__('Post Options','doctreat_core'), 'post');
			$this->add_meta_box('booking_options', esc_html__('Booking Details','doctreat_core'), 'booking');
			$this->add_meta_box('doctors_options', esc_html__('Doctors Options','doctreat_core'), 'doctors');
			$this->add_meta_box('hospitals_options', esc_html__('Hospital Options','doctreat_core'), 'hospitals');
			$this->add_meta_box('forum_options', esc_html__('Health Forum Options','doctreat_core'), 'healthforum');
        }
        ...
        public function page_options() {
            include DoctreatGlobalSettings::get_plugin_path() . 'admin/metaboxes/page-options.php';
        }
        ...
        public function post_options() {
            include DoctreatGlobalSettings::get_plugin_path() . 'admin/metaboxes/post-options.php';
        }
        ...
        public function doctors_options() {
            include DoctreatGlobalSettings::get_plugin_path() . 'admin/metaboxes/doctors-options.php';
        }
        ...
        public function forum_options() {
            include DoctreatGlobalSettings::get_plugin_path() . 'admin/metaboxes/forum-options.php';
        }
        ...
        public function hospitals_options() {
            include DoctreatGlobalSettings::get_plugin_path() . 'admin/metaboxes/hospitals-options.php';
        }
        ...
        public function booking_options() {
            include DoctreatGlobalSettings::get_plugin_path() . 'admin/metaboxes/booking-options.php';
        }
