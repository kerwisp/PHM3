...
if (!class_exists('DoctreatHospitalTeamNotify')) {
    ...
    class DoctreatHospitalTeamNotify extends Doctreat_Email_helper{
		...
		public function send_request_email($params = '') {
			...
			extract($params);
			$email_to 			= $email;
			$subject_default 	= esc_html__('Send request', 'doctreat_core');
			...
			$subject		= !empty( $theme_settings['doctor_hospital_request_subject'] ) ? $theme_settings['doctor_hospital_request_subject'] : $subject_default;
			
			$email_content	= !empty( $theme_settings['doctor_hospital_request_content'] ) ? $theme_settings['doctor_hospital_request_content'] : $contact_default;
		...
		public function send_approved_email($params = '') {
			...
			extract($params);
			$email_to 			= $email;
			$subject_default 	= esc_html__('Approved request to join hospital', 'doctreat_core');
			...
			$subject		= !empty( $theme_settings['doctor_approved_request_subject'] ) ? $theme_settings['doctor_approved_request_subject'] : $subject_default;
			
			$email_content	= !empty( $theme_settings['doctor_approved_request_content'] ) ? $theme_settings['doctor_approved_request_content'] : $contact_default;
		...
		public function send_cancelled_email($params = '') {
			...
			extract($params);
			$email_to 			= $email;
			$subject_default 	= esc_html__('Cancelled request to join hospital', 'doctreat_core');
			$contact_default 	= wp_kses(__('Hello %doctor_name%,<br/>
			...
			$subject		= !empty( $theme_settings['hospital_request_cancelled_subject'] ) ? $theme_settings['hospital_request_cancelled_subject'] : $subject_default;
			
			$email_content	= !empty( $theme_settings['hospital_request_cancelled_content'] ) ? $theme_settings['hospital_request_cancelled_content'] : $contact_default;
	...
	new DoctreatHospitalTeamNotify();
}