...
if (!class_exists('DoctreatGetPasswordNotify')) {
    ...
    class DoctreatGetPasswordNotify extends Doctreat_Email_helper{
		...
		public function send($params = '') {
			...
			$subject_default = esc_html__('Forgot Password', 'doctreat_core');
			$contact_default = 'Hi %name%,<br/>
								...
								%signature%';
			$subject			= !empty( $theme_settings['change_password_subject'] ) ? $theme_settings['change_password_subject'] : $subject_default;
			$email_content		= !empty( $theme_settings['change_password_content'] ) ? $theme_settings['change_password_content'] : $subject_default;
