 ...
 * @return 
 */
if (!function_exists('doctreat_update_healthforum_comments_author')) {
	function doctreat_update_healthforum_comments_author() {
		global $current_user;
		if(apply_filters('doctreat_get_user_type', $current_user->ID ) !== 'administrator'){return;}
 ...
 * @return 
 */
if (!function_exists('doctreat_update_post_auther_hospital_team')) {
	function doctreat_update_post_auther_hospital_team() {
		global $current_user;
		if(apply_filters('doctreat_get_user_type', $current_user->ID ) !== 'administrator'){return;}
 ...
 * @return 
 */
if (!function_exists('doctreat_update_post_auther_healthforum')) {
	function doctreat_update_post_auther_healthforum() {
		global $current_user;
		if(apply_filters('doctreat_get_user_type', $current_user->ID ) !== 'administrator'){return;}
 ...
 * @return 
 */
if (!function_exists('doctreat_update_post_auther')) {
	function doctreat_update_post_auther() {
		global $current_user;
		if(apply_filters('doctreat_get_user_type', $current_user->ID ) !== 'administrator'){return;}
 ...
 * @return 
 */
if (!function_exists('doctreat_import_languages')) {
	//add_action( 'init', 'doctreat_import_languages' );
    function doctreat_import_languages() {
		global $current_user;
		if(apply_filters('doctreat_get_user_type', $current_user->ID ) !== 'administrator'){return;}
		
        $langs	= doctreat_prepare_languages();
 ...
 * @return 
 */
if(!function_exists('doctreat_get_random_ids') ) {
	function doctreat_get_random_ids($scale,$start,$end){
		shuffle($scale);
 ...
 * @return 
 */
if(!function_exists('doctreat_get_random_key') ) {
	function doctreat_get_random_key($array){
