...
if (!class_exists('Doctreat_Core')) {
    ...
    class Doctreat_Core {
         ...
         *
         * - Doctreat_Loader. Orchestrates the hooks of the plugin.
         * - Doctreat_i18n. Defines internationalization functionality.
         * - Doctreat_Admin. Defines all hooks for the admin area.
         * - Doctreat_Public. Defines all hooks for the public side of the site.
         *
        ...
        private function load_dependencies() {
            ...
            $this->loader = new Doctreat_Loader();
        }

        /**
         * Define the locale for this plugin for internationalization.
         *
         * Uses the Doctreat_i18n class in order to set the domain and to register the hook
         * with WordPress.
         *
         * @since    1.0.0
         * @access   private
        ...
        private function define_admin_hooks() {
            $plugin_admin = new Doctreat_Admin();
        ...
        private function define_public_hooks() {
            ...
            $plugin_public = new Doctreat_Public();
         ...
         *
         * @since     1.0.0
         * @return    Doctreat_Loader    Orchestrates the hooks of the plugin.
         */
